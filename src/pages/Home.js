  ...
  return (
    <>
        ...
        <div className="container text-center single-col-max-width">
          <div className="hero-content">
            ...
            <div className="intro">
              ...
              <Link to="/portfolio" className="btn btn-light btn-lg me-3 fw-bold shadow-sm">View Portfolio</Link>
              <Link to="/contact" className="btn btn-outline-light btn-lg fw-bold">Contact Me</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="container px-3 px-lg-5">
        ...
        {/* About Me Card */}
        <section className="theme-bg-light shadow-sm p-4 p-lg-5 mb-5 bg-white rounded-3">
